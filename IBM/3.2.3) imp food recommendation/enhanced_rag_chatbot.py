...
model = OllamaLLM(model="phi3:mini", base_url="http://127.0.0.1:11434")
...
def main():
    ...
    try:
        ...
        # Load food data
        global food_items
        food_items = load_food_data('./IBM/3.2.3) imp food recommendation/FoodDataSet.json')
        ...
        test_response = model.invoke("Hello") #, params=None)
